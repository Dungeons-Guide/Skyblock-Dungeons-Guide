...
public class TextUtils {
    public static Component fromText(Text text) {
        JsonElement elem = TextCodecs.CODEC.encodeStart(JsonOps.INSTANCE, text).getOrThrow();
    ...
    public static Text fromComponent(Component component) {
        ...
        return TextCodecs.CODEC.decode(JsonOps.INSTANCE, elem).getOrThrow().getFirst();
    }
}
