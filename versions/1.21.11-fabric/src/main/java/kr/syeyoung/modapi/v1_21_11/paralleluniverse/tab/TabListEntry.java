...
public class TabListEntry implements UTabListEntry {
    ...
    public String getEffectiveName() {
        ...
        Team team = TeamManager.INSTANCE.getPlayerTeam(gameProfile.name());
        if (team != null) {
            return team.getPrefix() + gameProfile.name() + team.getSuffix();
        }
