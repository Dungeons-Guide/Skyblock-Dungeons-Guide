...
@Data
public class DungeonArrowTrap implements DungeonMechanic {
    ...
    public void highlight(Color color, String name, DungeonRoom dungeonRoom, float partialTicks) {
        if (dispensers.getOffsetPointList().isEmpty()) return;
        OffsetPoint firstPoint = dispensers.getOffsetPointList().get(0);
        ...
        for (OffsetPoint offsetPoint : dispensers.getOffsetPointList()) {
            RenderUtils.highlightBlock(offsetPoint.getBlockPos(dungeonRoom), color, partialTicks);
        }
    }


    public DungeonArrowTrap clone() throws CloneNotSupportedException {
        DungeonArrowTrap dungeonSecret = new DungeonArrowTrap();
    ...
    public OffsetPoint getRepresentingPoint(DungeonRoom dungeonRoom) {
        return dispensers.getOffsetPointList().size() == 0 ? null : dispensers.getOffsetPointList().get(0);
    }
}
