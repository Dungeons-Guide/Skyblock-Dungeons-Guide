...
@Data
public class DungeonSecretDoubleChest implements DungeonMechanic, ISecret {
    ...
    public void buildAction(String state, DungeonRoom dungeonRoom, ActionDAGBuilder builder) throws PathfindImpossibleException {
        ...
        if (state.equals("found") && getSecretStatus(dungeonRoom) == SecretStatus.FOUND) return;
            builder = builder.requires(new AtomicAction.Builder()
                    ...
                    .requires(new ActionClick(secretPoint2))
    ...
    public void highlight(Color color, String name, DungeonRoom dungeonRoom, float partialTicks) {
        ...
        RenderUtils.highlightBlock(getSecretPoint2().getBlockPos(dungeonRoom), color, partialTicks);
    ...
    public DungeonSecretDoubleChest clone() throws CloneNotSupportedException {
        DungeonSecretDoubleChest dungeonSecret = new DungeonSecretDoubleChest();
