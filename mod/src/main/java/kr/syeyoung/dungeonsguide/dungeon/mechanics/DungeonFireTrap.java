...
@Data
public class DungeonFireTrap implements DungeonMechanic {
    ...
    public DungeonFireTrap clone() throws CloneNotSupportedException {
        DungeonFireTrap dungeonSecret = new DungeonFireTrap();
