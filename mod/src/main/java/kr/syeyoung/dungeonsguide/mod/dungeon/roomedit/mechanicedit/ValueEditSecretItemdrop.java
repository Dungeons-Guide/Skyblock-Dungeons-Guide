...
import kr.syeyoung.dungeonsguide.mod.dungeon.data.mechanics.DungeonSecretItemDropState.DungeonSecretItemDropData;
...
public class ValueEditSecretItemdrop extends MPanel implements ValueEdit<DungeonSecretItemDropData> {
    private final DungeonSecretItemDropState dummyState;

    public ValueEditSecretItemdrop(final Parameter parameter2) {
        this.parameter = parameter2;
        this.dungeonSecretItemDrop = (DungeonSecretItemDropData) parameter2.getNewData();
        this.dummyState = dungeonSecretItemDrop.createState(EditingContext.getEditingContext().getRoom());
        label = new MLabel();
    ...
    // just create
    // add set
    private final DungeonSecretItemDropData dungeonSecretItemDrop;
    ...
    public static class Generator implements ValueEditCreator<ValueEditSecretItemdrop> {
        ...
        public Object createDefaultValue(Parameter parameter) {
            return new DungeonSecretItemDropData();
        }

        @Override
        public Object cloneObj(Object object) {
            try {
                return ((DungeonSecretItemDropData) object).clone();
