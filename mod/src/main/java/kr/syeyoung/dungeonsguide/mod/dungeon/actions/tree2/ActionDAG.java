...
public class ActionDAG {
    ...
    public Iterator<List<ActionDAGNode>> topologicalSort(int dagId) {
        return new Iterator<List<ActionDAGNode>>() {
            boolean[] visited = new boolean[allNodes.size()];
            int[] degree = new int[allNodes.size()];
            Stack<Integer> path = new Stack<>();
            List<ActionDAGNode> nextSolution;
            int solutionSize;
            {
