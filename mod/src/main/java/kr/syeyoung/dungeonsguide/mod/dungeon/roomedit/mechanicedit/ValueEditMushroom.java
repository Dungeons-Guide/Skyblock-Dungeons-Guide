...
import kr.syeyoung.dungeonsguide.mod.dungeon.data.mechanics.DungeonMushroomState.DungeonMushroomData;
...
public class ValueEditMushroom extends MPanel implements ValueEdit<DungeonMushroomData> {
    private final DungeonMushroomState dummyState;

    public ValueEditMushroom(final Parameter parameter2) {
        this.parameter = parameter2;
        this.dungeonSecret = (DungeonMushroomData) parameter2.getNewData();
    ...
    // just create
    // add set
    private final DungeonMushroomData dungeonSecret;
    ...
    public static class Generator implements ValueEditCreator<ValueEditMushroom> {
        ...
        public Object createDefaultValue(Parameter parameter) {
            return new DungeonMushroomData();
        }

        @Override
        public Object cloneObj(Object object) {
            try {
                return ((DungeonMushroomData) object).clone();
