...
import kr.syeyoung.dungeonsguide.mod.dungeon.data.mechanics.DungeonTombState.DungeonTombData;
...
public class ValueEditTomb extends MPanel implements ValueEdit<DungeonTombData> {
    private final DungeonTombState dummyState;

    public ValueEditTomb(final Parameter parameter2) {
        this.parameter = parameter2;
        this.dungeonTomb = (DungeonTombData) parameter2.getNewData();
        this.dummyState = dungeonTomb.createState(EditingContext.getEditingContext().getRoom());
        label = new MLabel();
    ...
    // just create
    // add set
    private final DungeonTombData dungeonTomb;
    ...
    public static class Generator implements ValueEditCreator<ValueEditTomb> {
        ...
        public Object createDefaultValue(Parameter parameter) {
            return new DungeonTombData();
        }

        @Override
        public Object cloneObj(Object object) {
            try {
                return ((DungeonTombData) object).clone();
