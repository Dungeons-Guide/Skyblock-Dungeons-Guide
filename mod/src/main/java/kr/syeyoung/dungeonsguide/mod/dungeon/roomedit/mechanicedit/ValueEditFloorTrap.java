...
import kr.syeyoung.dungeonsguide.mod.dungeon.data.mechanics.DungeonFloorTrapState.DungeonFloorTrapData;
...
public class ValueEditFloorTrap extends MPanel implements ValueEdit<DungeonFloorTrapData> {
    private final DungeonFloorTrapState dummyState;

    public ValueEditFloorTrap(final Parameter parameter2) {
        this.parameter = parameter2;
        this.dungeonFloorTrap = (DungeonFloorTrapData) parameter2.getNewData();
        this.dummyState = dungeonFloorTrap.createState(EditingContext.getEditingContext().getRoom());
        label = new MLabel();
    ...
    // just create
    // add set
    private final DungeonFloorTrapData dungeonFloorTrap;
    ...
    public static class Generator implements ValueEditCreator<ValueEditFloorTrap> {
        ...
        public Object createDefaultValue(Parameter parameter) {
            return new DungeonFloorTrapData();
        }

        @Override
        public Object cloneObj(Object object) {
            try {
                return ((DungeonFloorTrapData) object).clone();
