...
public class ValueEditSecretDoubleChest extends MPanel implements ValueEdit<DungeonSecretChest> {
    ...
    public ValueEditSecretDoubleChest(final Parameter parameter2) {
        ...
        value2 = new MValue(dungeonSecretChest.getSecretPoint(), Collections.emptyList());
        add(value2);
