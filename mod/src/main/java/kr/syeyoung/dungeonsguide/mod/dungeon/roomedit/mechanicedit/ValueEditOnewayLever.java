...
import kr.syeyoung.dungeonsguide.mod.dungeon.data.mechanics.DungeonOnewayLeverState.DungeonOnewayLeverData;
...
public class ValueEditOnewayLever extends MPanel implements ValueEdit<DungeonOnewayLeverData> {
    private final DungeonOnewayLeverState dummyState;

    public ValueEditOnewayLever(final Parameter parameter2) {
        this.parameter = parameter2;
        this.dungeonLever = (DungeonOnewayLeverData) parameter2.getNewData();
    ...
    // just create
    // add set
    private final DungeonOnewayLeverData dungeonLever;
    ...
    public static class Generator implements ValueEditCreator<ValueEditOnewayLever> {
        ...
        public Object createDefaultValue(Parameter parameter) {
            return new DungeonOnewayLeverData();
        }

        @Override
        public Object cloneObj(Object object) {
            try {
                return ((DungeonOnewayLeverData) object).clone();
