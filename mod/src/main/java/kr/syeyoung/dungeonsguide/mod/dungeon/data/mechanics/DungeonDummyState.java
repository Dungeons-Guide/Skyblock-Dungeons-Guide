...
@Data
public class DungeonDummyState implements DungeonMechanicState {
    private final DungeonDummyData data;
    private final DungeonRoom room;
    public DungeonDummyState(DungeonDummyData data, DungeonRoom room) {
        this.data = data;
        this.room = room;
    }
    ...
    public void highlight(Color color, String name, UWorldRenderContext context, float partialTicks) {
        ...
        context.drawTextAtWorld("D-"+name, pos.getX() +0.5f, pos.getY()+0.375f, pos.getZ()+0.5f, 0xFFFFFFFF, 0.03f, false, true, partialTicks);
    ...
    @Data
    public static class DungeonDummyData implements DungeonMechanicData {
        private OffsetPoint secretPoint = new OffsetPoint(0, 0, 0);
        private List<String> preRequisite = new ArrayList<String>();

        public DungeonDummyData() {
        }

        public DungeonDummyData clone() throws CloneNotSupportedException {
            DungeonDummyData dungeonSecret = new DungeonDummyData();
        ...
        @Override
        public DungeonDummyState createState(DungeonRoom room) {
            return new DungeonDummyState(this, room);
        }
    }
}
