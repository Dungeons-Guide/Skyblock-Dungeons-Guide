...
import kr.syeyoung.dungeonsguide.mod.dungeon.data.mechanics.DungeonDummyState.DungeonDummyData;
...
public class ValueEditDummy extends MPanel implements ValueEdit<DungeonDummyData> {
    private final DungeonDummyState dummyState;

    public ValueEditDummy(final Parameter parameter2) {
        this.parameter = parameter2;
        this.dungeonSecret = (DungeonDummyData) parameter2.getNewData();
    ...
    // just create
    // add set
    private final DungeonDummyData dungeonSecret;
    ...
    public static class Generator implements ValueEditCreator<ValueEditDummy> {
        ...
        public Object createDefaultValue(Parameter parameter) {
            return new DungeonDummyData();
        }

        @Override
        public Object cloneObj(Object object) {
            try {
                return ((DungeonDummyData) object).clone();
