...
import kr.syeyoung.dungeonsguide.mod.dungeon.data.mechanics.DungeonNPCState.DungeonNPCData;
...
public class ValueEditNPC extends MPanel implements ValueEdit<DungeonNPCData> {
    private final DungeonNPCState dummyState;

    public ValueEditNPC(final Parameter parameter2) {
        this.parameter = parameter2;
        this.dungeonSecret = (DungeonNPCData) parameter2.getNewData();
    ...
    // just create
    // add set
    private final DungeonNPCData dungeonSecret;
    ...
    public static class Generator implements ValueEditCreator<ValueEditNPC> {
        ...
        public Object createDefaultValue(Parameter parameter) {
            return new DungeonNPCData();
        }

        @Override
        public Object cloneObj(Object object) {
            try {
                return ((DungeonNPCData) object).clone();
