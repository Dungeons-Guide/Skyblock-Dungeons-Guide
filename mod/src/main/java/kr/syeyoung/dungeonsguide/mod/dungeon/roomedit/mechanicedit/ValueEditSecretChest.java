...
import kr.syeyoung.dungeonsguide.mod.dungeon.data.mechanics.DungeonSecretChestState.DungeonSecretChestData;
...
public class ValueEditSecretChest extends MPanel implements ValueEdit<DungeonSecretChestData> {
    private final DungeonSecretChestState dummyState;

    public ValueEditSecretChest(final Parameter parameter2) {
        this.parameter = parameter2;
        this.dungeonSecretChest = (DungeonSecretChestData) parameter2.getNewData();
        this.dummyState = dungeonSecretChest.createState(EditingContext.getEditingContext().getRoom());
        label = new MLabel();
    ...
    // just create
    // add set
    private final DungeonSecretChestData dungeonSecretChest;
    ...
    public static class Generator implements ValueEditCreator<ValueEditSecretChest> {

        @Override
        public ValueEditSecretChest createValueEdit(Parameter parameter) {
            return new ValueEditSecretChest(parameter);
        }

        @Override
        public Object createDefaultValue(Parameter parameter) {
            return new DungeonSecretChestData();
        }

        @Override
        public Object cloneObj(Object object) {
            try {
                return ((DungeonSecretChestData) object).clone();
