    ...
    * */
    ...
    public BossfightProcessorMasterModeNecron() {
        ...
        addPhase(PhaseData.builder()
                ...
                .signatureMsg("§4[BOSS] Necron§c: §cThe Catacombs... are no more.")
                .nextPhase("won").nextPhase("lost").build());
        addPhase(PhaseData.builder()
                .phase("won")
                .signatureMsg("§4[BOSS] Necron§c: §cIncredible. You did what I couldn't do myself.").build()
        );
        addPhase(PhaseData.builder()
                .phase("lost")
                ...
                .signatureMsg("§4[BOSS] Wither King§c: Thank you for coming all the way here.")
                .build()
        );
    }
