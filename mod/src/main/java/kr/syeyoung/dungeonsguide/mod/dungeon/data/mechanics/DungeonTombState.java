...
@Data
public class DungeonTombState implements DungeonMechanicState, WorldMutatingMechanicState {
    private final DungeonTombData data;
    private final DungeonRoom room;
    public DungeonTombState(DungeonTombData data, DungeonRoom room) {
        this.data = data;
        this.room = room;
    }
    ...
    public Set<String> getAvailableActions() {
        return isBlocking(room) ? Sets.newHashSet("open", "navigate") : Sets.newHashSet("navigate");
    }
    ...
    @Data
    public static class DungeonTombData implements WorldMutatingMechanicData {
        private OffsetPointSet secretPoint = new OffsetPointSet();
        private List<String> preRequisite = new ArrayList<>();


        public DungeonTombData() {
        }

        @Override
        public DungeonTombState createState(DungeonRoom room) {
            return new DungeonTombState(this, room);
        }

        public DungeonTombData clone() throws CloneNotSupportedException {
            DungeonTombData data = new DungeonTombData();
