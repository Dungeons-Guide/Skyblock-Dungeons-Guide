...
import kr.syeyoung.dungeonsguide.launcher.guiv2.elements.image.ResourceImage;
import kr.syeyoung.dungeonsguide.launcher.guiv2.elements.image.URLImage;
import kr.syeyoung.dungeonsguide.launcher.guiv2.elements.popups.PopupMgr;
import kr.syeyoung.dungeonsguide.launcher.guiv2.view.TestView;
...
public class DomElementRegistry {
    ...
    static {
        ...
        register("SimpleToggleButton", new DelegatingWidgetConverter(new ResourceLocation("dungeons_guide_loader:gui/elements/simpleToggleButton.gui")));
        register("SimpleHorizontalScrollBar", new DelegatingWidgetConverter(new ResourceLocation("dungeons_guide_loader:gui/elements/simpleHorizontalScrollBar.gui")));
        register("SimpleVerticalScrollBar", new DelegatingWidgetConverter(new ResourceLocation("dungeons_guide_loader:gui/elements/simpleVerticalScrollBar.gui")));
        register("SlowList", new DelegatingWidgetConverter(new ResourceLocation("dungeons_guide_loader:gui/elements/slowlist.gui")));
        register("size", new DelegatingWidgetConverter(new ResourceLocation("dungeons_guide_loader:gui/elements/size.gui")));
        register("ResourceImage", new DelegatingWidgetConverter(new ResourceLocation("dungeons_guide_loader:gui/elements/ratioResourceImage.gui")));
