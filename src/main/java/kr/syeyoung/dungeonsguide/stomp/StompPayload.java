...
public class StompPayload {
    ...
    public String getBuilt() {
        ...
        if (payload != null)
            sb.append(payload);
        sb.append((char) 0);
        if (FeatureRegistry.getInstance().DEBUG.isEnabled()) System.out.println("Sending.. "+ sb);
        return sb.toString();
    }

    public static StompPayload parse(String payload) {
        if (FeatureRegistry.getInstance().DEBUG.isEnabled()) System.out.println("Receving.. "+payload);
